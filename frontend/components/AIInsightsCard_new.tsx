...
export function InsightsMentorCard({ insight, dailyLimit, currentUsage, averageUsage, dailyConsumption }: AIInsightsCardProps) {
  const { usageForecast, weatherForecast, isLoading: forecastLoading } = useForecasts()
  ...
  if (!insight) {
    ...
    return (
      <div className="space-y-6">
        ...
        <ForecastSection usageForecast={usageForecast} weatherForecast={weatherForecast} isLoading={forecastLoading} />
      </div>
    )
  }
